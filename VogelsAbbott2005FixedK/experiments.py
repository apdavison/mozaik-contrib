...
def create_experiments(model):
    ...
    return  [
                           ...
                           PoissonNetworkKick(model,duration=10*7,drive_period=200.0,sheet_list=["V1_Exc_L4","V1_Inh_L4"],recording_configuration={'component' : 'mozaik.sheets.population_selector.RCRandomPercentage','params' : {'percentage' : 100.0}},lambda_list=[400.0,400.0],weight_list=[0.004,0.004]),
