...
from mozaik.meta_workflow.analysis import parameter_search_run_script_distributed_slurm
...
parameter_search_run_script_distributed_slurm("SelfSustainedPushPull",directory,'run_analysis.py',32)
