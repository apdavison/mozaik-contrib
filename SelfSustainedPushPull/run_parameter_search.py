...
CombinationParameterSearch(SlurmSequentialBackend(num_threads=8,num_mpi=1),{'l4_cortex_exc.L4ExcL4InhConnection.base_weight' : numpy.linspace(0.0007,0.0011,5),'l4_cortex_inh.rand_struct_ratio' : numpy.linspace(0.5,1.0,10)}).run_parameter_search()
