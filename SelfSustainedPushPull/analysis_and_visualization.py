...
def perform_analysis_and_visualization(data_store):
    ...
    if True:#ANALYSIS
        ...
        PSTH(param_filter_query(data_store,st_direct_stimulation_name="None"),ParameterSet({'bin_length' : 2.0})).analyse()
    ...
    if True: # PLOTTING
            ...
            OverviewPlot(dsv,ParameterSet({'sheet_name' : 'V1_Exc_L4', 'neuron' : analog_ids[0], 'sheet_activity' : {}}),fig_param={'dpi' : 100,'figsize': (28,12)},plot_file_name='SSExcAnalog.png').plot({'Vm_plot.y_lim' : (-80,-50),'Conductance_plot.y_lim' : (0,80.0)})
            OverviewPlot(dsv,ParameterSet({'sheet_name' : 'V1_Exc_L4', 'neuron' : analog_ids[1], 'sheet_activity' : {}}),fig_param={'dpi' : 100,'figsize': (28,12)},plot_file_name='SSExcAnalog1.png').plot({'Vm_plot.y_lim' : (-80,-50),'Conductance_plot.y_lim' : (0,80.0)})
            OverviewPlot(dsv,ParameterSet({'sheet_name' : 'V1_Exc_L4', 'neuron' : analog_ids[2], 'sheet_activity' : {}}),fig_param={'dpi' : 100,'figsize': (28,12)},plot_file_name='SSExcAnalog2.png').plot({'Vm_plot.y_lim' : (-80,-50),'Conductance_plot.y_lim' : (0,80.0)})
            ...
            dsv = param_filter_query(data_store,st_name='FullfieldDriftingSinusoidalGrating')    
            OverviewPlot(dsv,ParameterSet({'sheet_name' : 'V1_Exc_L4', 'neuron' : l4_exc, 'sheet_activity' : {}}),fig_param={'dpi' : 100,'figsize': (28,12)},plot_file_name="Exc.png").plot({'Vm_plot.y_lim' : (-80,-50),'Conductance_plot.y_lim' : (0,80.0)})
            OverviewPlot(dsv,ParameterSet({'sheet_name' : 'V1_Inh_L4', 'neuron' : l4_inh, 'sheet_activity' : {}}),fig_param={'dpi' : 100,'figsize': (28,12)},plot_file_name="Inh.png").plot({'Vm_plot.y_lim' : (-80,-50),'Conductance_plot.y_lim' : (0,80.0)})

            OverviewPlot(dsv,ParameterSet({'sheet_name' : 'V1_Exc_L4', 'neuron' : analog_ids[0], 'sheet_activity' : {}}),fig_param={'dpi' : 100,'figsize': (28,12)},plot_file_name="Exc1.png").plot({'Vm_plot.y_lim' : (-80,-50),'Conductance_plot.y_lim' : (0,80.0)})
            OverviewPlot(dsv,ParameterSet({'sheet_name' : 'V1_Inh_L4', 'neuron' : analog_ids_inh[0], 'sheet_activity' : {}}),fig_param={'dpi' : 100,'figsize': (28,12)},plot_file_name="Inh1.png").plot({'Vm_plot.y_lim' : (-80,-50),'Conductance_plot.y_lim' : (0,80.0)})
            OverviewPlot(dsv,ParameterSet({'sheet_name' : 'V1_Exc_L4', 'neuron' : analog_ids[1], 'sheet_activity' : {}}),fig_param={'dpi' : 100,'figsize': (28,12)},plot_file_name="Exc2.png").plot({'Vm_plot.y_lim' : (-80,-50),'Conductance_plot.y_lim' : (0,80.0)})
            OverviewPlot(dsv,ParameterSet({'sheet_name' : 'V1_Inh_L4', 'neuron' : analog_ids_inh[1], 'sheet_activity' : {}}),fig_param={'dpi' : 100,'figsize': (28,12)},plot_file_name="Inh2.png").plot({'Vm_plot.y_lim' : (-80,-50),'Conductance_plot.y_lim' : (0,80.0)})
            OverviewPlot(dsv,ParameterSet({'sheet_name' : 'V1_Exc_L4', 'neuron' : analog_ids[2], 'sheet_activity' : {}}),fig_param={'dpi' : 100,'figsize': (28,12)},plot_file_name="Exc3.png").plot({'Vm_plot.y_lim' : (-80,-50),'Conductance_plot.y_lim' : (0,80.0)})
            OverviewPlot(dsv,ParameterSet({'sheet_name' : 'V1_Inh_L4', 'neuron' : analog_ids_inh[2], 'sheet_activity' : {}}),fig_param={'dpi' : 100,'figsize': (28,12)},plot_file_name="Inh3.png").plot({'Vm_plot.y_lim' : (-80,-50),'Conductance_plot.y_lim' : (0,80.0)})
            OverviewPlot(dsv,ParameterSet({'sheet_name' : 'V1_Exc_L4', 'neuron' : analog_ids[3], 'sheet_activity' : {}}),fig_param={'dpi' : 100,'figsize': (28,12)},plot_file_name="Exc4.png").plot({'Vm_plot.y_lim' : (-80,-50),'Conductance_plot.y_lim' : (0,80.0)})
            OverviewPlot(dsv,ParameterSet({'sheet_name' : 'V1_Inh_L4', 'neuron' : analog_ids_inh[3], 'sheet_activity' : {}}),fig_param={'dpi' : 100,'figsize': (28,12)},plot_file_name="Inh4.png").plot({'Vm_plot.y_lim' : (-80,-50),'Conductance_plot.y_lim' : (0,80.0)})
            
            print l4_exc_or[0].get_value_by_id(analog_ids[0])
            print l4_exc_or[0].get_value_by_id(analog_ids[1])
            print l4_exc_or[0].get_value_by_id(analog_ids[2])
            print l4_exc_or[0].get_value_by_id(analog_ids[3])
            print l4_inh_or[0].get_value_by_id(analog_ids_inh[0])
            print l4_inh_or[0].get_value_by_id(analog_ids_inh[1])
            print l4_inh_or[0].get_value_by_id(analog_ids_inh[2])
            print l4_inh_or[0].get_value_by_id(analog_ids_inh[3])
            ...
            dsv = param_filter_query(data_store,sheet_name=['V1_Exc_L4'],value_name=['LGNAfferentOrientation']) +  param_filter_query(data_store,sheet_name=['V1_Exc_L4'],value_name=['orientation preference'],analysis_algorithm=['GaussianTuningCurveFit'])  
            PerNeuronValueScatterPlot(dsv,ParameterSet({}),plot_file_name='OR_correlation.png',fig_param={'dpi' : 100,'figsize': (28,12)}).plot()
