...
def create_experiments(model):
    return              [
                           ...
                           #MeasureSpontaneousActivity(model,duration=147*7,num_trials=1),
                           ...
                           MeasureOrientationTuningFullfield(model,num_orientations=2,spatial_frequency=0.8,temporal_frequency=2,grating_duration=147*7*2,contrasts=[100],num_trials=1),
                           ...
                           MeasureNaturalImagesWithEyeMovement(model,stimulus_duration=6*147*7,num_trials=5),
