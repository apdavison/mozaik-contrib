...
CombinationParameterSearch(SlurmSequentialBackend(num_threads=1,num_mpi=1),{'l4_cortex_exc.params.artificial_stimulators.background_act.params.exc_firing_rate' : numpy.linspace(0.0,10000,30),'l4_cortex_exc.params.cell.params.cm' : [0.1,0.2,0.3], 'l4_cortex_exc.params.cell.params.tau_m':  [5.0,10.0,20.0,40.0,80.0] }).run_parameter_search()