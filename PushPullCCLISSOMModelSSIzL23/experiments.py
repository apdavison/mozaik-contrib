...
def create_experiments(model):
    ...
    return  [
                ...
                MeasureOrientationTuningFullfield(model,num_orientations=8,spatial_frequency=0.8,temporal_frequency=2,grating_duration=147*7,contrasts=[5,100],num_trials=10),
...
def create_experiments_stc(model):
    ...
    return  [
                           ...
                           #Size Tuning  
                           MeasureSizeTuning(model,num_sizes=10,max_size=4.0,orientation=0,spatial_frequency=0.8,temporal_frequency=2,grating_duration=147*7,contrasts=[5,100],num_trials=10),
            ]
