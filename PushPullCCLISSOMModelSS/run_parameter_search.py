...
CombinationParameterSearch(SlurmSequentialBackend(num_threads=1,num_mpi=16),{'l4_cortex_exc.L4ExcL4ExcConnection.base_weight' : [0.0004],'l4_cortex_exc.L4ExcL4InhConnection.base_weight' : [0.0005,0.0003,0.0001,0.00005],'l4_cortex_inh.L4InhL4ExcConnection.base_weight' : [0.0004,0.0006,0.001], 'l4_cortex_inh.ExcInhAfferentRatio' : [0.5,1.0,2.0],'retina_lgn.params.gain' : [2.0],'l4_cortex_exc.rand_struct_ratio' : [0.85], 'l4_cortex_exc.L4ExcL4ExcConnection.weight_functions.f1.params.sigma' : [0.9],'l4_cortex_exc.params.cell.params.v_reset' : [-55]}).run_parameter_search()
