...
CombinationParameterSearch(SlurmSequentialBackend(num_threads=1,num_mpi=16),{'l4_cortex_exc.L4ExcL4InhConnection.base_weight' : numpy.linspace(0.00042,0.0005,5),'l4_cortex_inh.L4InhL4ExcConnection.base_weight' : numpy.linspace(0.0048,0.0058,4),'l4_cortex_exc.AfferentConnection.num_samples' : numpy.linspace(40,60,2)}).run_parameter_search()
...
#CombinationParameterSearch(SlurmSequentialBackend(num_threads=1,num_mpi=20),{'l4_cortex_exc.L4ExcL4ExcConnection.base_weight' : [0.00045],'l4_cortex_exc.L4ExcL4InhConnection.base_weight' : [0.0007],'l4_cortex_inh.L4InhL4ExcConnection.base_weight' : [0.0008], 'l4_cortex_inh.ExcInhAfferentRatio' : [1.0],'retina_lgn.params.gain' : [2.0,3.0,6.0],'l4_cortex_exc.rand_struct_ratio' : [0.85,0.95], 'l4_cortex_exc.L4ExcL4ExcConnection.weight_functions.f1.params.sigma' : [0.5,0.7,0.9],'l4_cortex_exc.params.cell.params.v_reset' : [-51], 'l4_cortex_exc.AfferentConnection.num_samples' : [20,30,40]}).run_parameter_search()