...
CombinationParameterSearch(SlurmSequentialBackend(num_threads=1,num_mpi=16),{'l4_cortex_exc.L4ExcL4InhConnection.base_weight' : [0.0003,0.0005,0.0007],'l4_cortex_exc.rand_struct_ratio' : [0.85,0.9,0.95],'l4_cortex_inh.L4InhL4ExcConnection.base_weight' : [0.0003,0.0002,0.0001],'l4_cortex_inh.ExcInhAfferentRatio' : [1.5]}).run_parameter_search()
