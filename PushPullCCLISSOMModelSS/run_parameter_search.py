...
#,'l4_cortex_exc.AfferentConnection.base_weight' : [0.0012],'l4_cortex_exc.AfferentConnection.num_samples' : [25]
CombinationParameterSearch(SlurmSequentialBackend(num_threads=1,num_mpi=16),{'l4_cortex_exc.L4ExcL4InhConnection.base_weight' : [0.0003,0.0005,0.0007],'l4_cortex_exc.rand_struct_ratio' : [0.85,0.95],'l4_cortex_inh.L4InhL4ExcConnection.base_weight' : [0.0002,0.00017,0.00014],'l4_cortex_inh.ExcInhAfferentRatio' : [1.2],'l4_cortex_inh.params.density' : [12000,6000],'retina_lgn.params.gain' : [0.7]}).run_parameter_search()
