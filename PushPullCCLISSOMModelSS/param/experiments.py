...
def create_experiments(model):
    ...
    return  [
                           ...
                           MeasureOrientationTuningFullfield(model,num_orientations=8,spatial_frequency=0.8,temporal_frequency=2,grating_duration=147*7,contrasts=[10,30,70,100],num_trials=10),
            ]
