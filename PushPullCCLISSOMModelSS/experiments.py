...
def create_experiments(model):
    ...
    return  [
                ...
                #MeasureDriftingSineGratingWithEyeMovement(model,spatial_frequency=0.8,temporal_frequency=6,stimulus_duration=6*147*7,num_trials=7,contrast=100),
...
def create_experiments_or(model):
    ...
    return  [
                           ...
                           MeasureOrientationTuningFullfield(model,num_orientations=2,spatial_frequency=0.8,temporal_frequency=6,grating_duration=143*7,contrasts=[100],num_trials=5),
