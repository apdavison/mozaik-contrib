...
def perform_analysis_and_visualization(data_store):
    ...
    if True: # PLOTTING
        ...
        RasterPlot(dsv,ParameterSet({'sheet_name' : 'V1_Exc_L4', 'neurons' : spike_ids,'trial_averaged_histogram': False}),plot_file_name='ExcRaster.png').plot({'SpikeRasterPlot.group_trials':True})
        RasterPlot(dsv,ParameterSet({'sheet_name' : 'V1_Inh_L4', 'neurons' : spike_ids_inh,'trial_averaged_histogram': False}),plot_file_name='InhRaster.png').plot({'SpikeRasterPlot.group_trials':True})
