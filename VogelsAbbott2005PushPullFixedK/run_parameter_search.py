...
import numpy
CombinationParameterSearch(SlurmSequentialBackend(num_threads=4,num_mpi=1),{'l4_cortex_exc.L4ExcL4ExcConnection.base_weight' : numpy.linspace(0.1,0.2,30),'l4_cortex_inh.L4InhL4ExcConnection.base_weight' : numpy.linspace(0.1,0.2,30)}).run_parameter_search()
