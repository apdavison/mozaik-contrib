...
import mozaik
from experiments import create_experiments_short,create_experiments_old,create_experiments,create_experiments_contr
...
if True:
    data_store,model = run_workflow('CorticalStimulationModel',SelfSustainedPushPull,create_experiments_contr)
    data_store.save() 
else: 
    setup_logging()
