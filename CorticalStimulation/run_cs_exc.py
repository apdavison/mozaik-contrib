...
import mozaik
from experiments import create_experiments_cortical_stimulation_exc
...
if True:
    data_store,model = run_workflow('CorticalStimulationModel',SelfSustainedPushPull,create_experiments_cortical_stimulation_exc)
    data_store.save() 
else: 
    setup_logging()
