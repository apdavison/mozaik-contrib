...
def analysis(data_store,analog_ids,analog_ids_inh,analog_ids23=None,analog_ids_inh23=None):
        ...
        l23_flag = ('V1_Exc_L2/3' in set(sheets)) and isinstance(analog_ids23, numpy.ndarray)
    ...
    if True:
            ...
            if True:
                ...
                if l23:
                    ...
                    if(len(param_filter_query(data_store,sheet_name=['V1_Inh_L2/3'],st_contrast=[5],analysis_algorithm=['TrialAveragedFiringRate'],st_orientation=[0]).get_analysis_result())!=0):
                        pref_fr_50 = param_filter_query(data_store,sheet_name=['V1_Inh_L2/3'],st_contrast=[5],analysis_algorithm=['TrialAveragedFiringRate'],st_orientation=[0],ads_unique=True).get_analysis_result()[0].get_value_by_id(l23_inh_or_many)
                        ort_fr_50 = param_filter_query(data_store,sheet_name=['V1_Inh_L2/3'],st_contrast=[5],analysis_algorithm=['TrialAveragedFiringRate'],st_orientation=[numpy.pi/2],ads_unique=True).get_analysis_result()[0].get_value_by_id(l23_inh_or_many)
                    ...
                    pylab.savefig(Global.root_directory+"Orientation_responseInhL23.png")
