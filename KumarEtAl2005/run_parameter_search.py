...
CombinationParameterSearch(SlurmSequentialBackend(num_threads=1,num_mpi=64),{'l4_cortex_exc.L4ExcL4ExcConnection.weights' : numpy.linspace(0.003,0.006,2),'l4_cortex_inh.L4InhL4ExcConnection.weights' : numpy.linspace(0.048,0.096,2)}).run_parameter_search()
